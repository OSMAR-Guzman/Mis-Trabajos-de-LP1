...
public class Detalle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtAticulo7 = new javax.swing.JTextField();
        txtArticulo8 = new javax.swing.JTextField();
        txtArticulo6 = new javax.swing.JTextField();
        txtArticulo5 = new javax.swing.JTextField();
        ...
        txtPrecioSinIVA15 = new javax.swing.JLabel();
        txtPrecioSinIVA14 = new javax.swing.JLabel();
        txtPrecioSinIVA13 = new javax.swing.JLabel();
        ...
        getContentPane().add(txtTotalPagar, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 390, 110, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("₲");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 390, -1, -1));

        txtAticulo7.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtAticulo7.setText("Azucar");
        txtAticulo7.setBorder(null);
        txtAticulo7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtAticulo7ActionPerformed(evt);
            }
        });
        getContentPane().add(txtAticulo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, -1, -1));

        txtArticulo8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtArticulo8.setText("Cafe");
        txtArticulo8.setBorder(null);
        ...
        txtArticulo6.setText("Yogurt");
        txtArticulo6.setBorder(null);
        txtArticulo6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtArticulo6ActionPerformed(evt);
            }
        });
        getContentPane().add(txtArticulo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 110, -1));

        txtArticulo5.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtArticulo5.setText("Huevo");
        txtArticulo5.setBorder(null);
        txtArticulo5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtArticulo5ActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(txtCantidad7, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 320, 30, 30));

        txtCantidad8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtCantidad8.setText("0");
        txtCantidad8.setBorder(null);
        getContentPane().add(txtCantidad8, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 350, 30, 30));

        txtCantidad6.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtCantidad6.setText("0");
        txtCantidad6.setBorder(null);
        getContentPane().add(txtCantidad6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 290, 30, 30));
        ...
        getContentPane().add(txtCantidad5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 260, 30, 30));
        ...
        getContentPane().add(txtPrecioSinIVA9, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 350, 60, 20));

        txtPrecioSinIVA15.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtPrecioSinIVA15.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtPrecioSinIVA15.setText("₲0");
        getContentPane().add(txtPrecioSinIVA15, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 315, 60, -1));

        txtPrecioSinIVA14.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtPrecioSinIVA14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtPrecioSinIVA14.setText("₲0");
        getContentPane().add(txtPrecioSinIVA14, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 290, 60, 20));

        txtPrecioSinIVA13.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtPrecioSinIVA13.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtPrecioSinIVA13.setText("₲0");
        getContentPane().add(txtPrecioSinIVA13, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 260, 60, 20));
        ...
        getContentPane().add(txtDescuento7, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 260, 70, -1));
        ...
        getContentPane().add(txtDescuento5, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 290, 70, -1));
        ...
        getContentPane().add(txtDescuento6, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 320, 70, -1));
        ...
        getContentPane().add(txtPrecioSinIVA5, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 260, 60, 20));
        ...
        getContentPane().add(txtPrecioSinIVA6, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 290, 60, 20));
        ...
        getContentPane().add(txtPrecioSinIVA8, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 360, 60, 20));

        fondo.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
    ...
    private void txtAticulo7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtAticulo7ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtAticulo7ActionPerformed

    private void txtArticulo5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtArticulo5ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtArticulo5ActionPerformed
    ...
    private void txtArticulo6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtArticulo6ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtArticulo6ActionPerformed
    ...
    private javax.swing.JTextField txtArticulo5;
    private javax.swing.JTextField txtArticulo6;
    private javax.swing.JTextField txtArticulo8;
    private javax.swing.JTextField txtAticulo7;
    ...
    private javax.swing.JLabel txtPrecioSinIVA13;
    private javax.swing.JLabel txtPrecioSinIVA14;
    private javax.swing.JLabel txtPrecioSinIVA15;
